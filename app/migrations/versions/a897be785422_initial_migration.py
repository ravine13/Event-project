...
Revision ID: a897be785422
Revises: 
Create Date: 2024-02-14 12:21:25.125394
...
def upgrade():
    ...
    op.create_table('Event_Billing',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('event_id', sa.UUID(), nullable=True),
    sa.Column('billing_id', sa.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['billing_id'], ['Billing_Info.id'], ),
